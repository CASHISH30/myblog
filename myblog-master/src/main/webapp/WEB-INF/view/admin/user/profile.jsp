...
<rapid:override name="content">
    ...
    <blockquote class="layui-elem-quote">
         <span class="layui-breadcrumb" lay-separator="/">
              ...
              <c:choose>
                  ...
                  <c:otherwise>
                      <a><cite>User information</cite></a>
                  </c:otherwise>
              </c:choose>
        </span>
    </blockquote>
    ...
    <form class="layui-form" action="/admin/user/editSubmit" id="userForm"
        ...
        <div class="layui-form-item">
            <a class="layui-btn layui-btn-primary"  href="/admin/user/edit/${user.userId}">Edit</a>
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">Creation time </label>
            <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text"  value='<c:choose>
                    <c:when test="${user.userStatus==0}">Disabled
                    </c:when>
                    <c:otherwise>Normal
                    </c:otherwise>
