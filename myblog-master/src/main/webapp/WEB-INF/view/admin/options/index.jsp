        ...
        <div class="layui-tab-content">
            ...
            <div class="layui-tab-item">
                <div class="layui-form-item">
                    ...
                    <div class="layui-form-mid layui-word-aux">Suggest 150px*150px</div>
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">Wechat QR code</label>
                    <div class="layui-input-inline">
                        <div class="layui-upload">
                            <div class="layui-upload-list" style="">
                            ...
                            <button type="button" class="layui-btn" id="test2">Upload picture</button>
                            <input type="hidden" id="optionAboutsiteWechat" name="optionAboutsiteWechat" value="${option.optionAboutsiteWechat}">
                        </div>
                    </div>
                    <div class="layui-form-mid layui-word-aux">Suggest 430px*430px</div>
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">Webo</label>
                    <div class="layui-input-inline">
