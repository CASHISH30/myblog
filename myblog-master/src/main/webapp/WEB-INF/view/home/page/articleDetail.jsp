    ...
    <div id="primary" class="content-area">
        <main id="main" class="site-main" role="main">
                    ...
                    <div id="social">
                        <div class="social-main">
                            ...
                            <div class="shang-p">
                                ...
                                <span class="shang-s">
                                    <a onclick="PaymentUtils.show();" style="cursor:pointer">Tip</a>
                                </span>
                            </div>
                            <div class="share-sd">
            ...
            <div class="authorbio wow fadeInUp">
                ...
                <ul class="postinfo">
                    <li></li>
                    <li><strong>Copyright notice：</strong>Original articles，at <fmt:formatDate
                    ...
                    <li class="reprinted"><strong>Indicate the resource：</strong>
                ...
                <div class="wow fadeInUp" data-wow-delay="0.3s">
                    <aside id="related_post-2" class="widget">
                        <h3 class="widget-title">
                            <span class="s-icon"></span>Related articles
                        </h3>
                ...
                <c:choose>
                    <c:when test="${preArticle!=null}">
                        <a href="/article/${preArticle.articleId}" rel="next">
                            <span class="meta-nav">
                                <span class="post-nav">Last article
                ...
                <c:choose>
                    <c:when test="${afterArticle!=null}">
                        <a href="/article/${afterArticle.articleId}" rel="next">
                            <span class="meta-nav">
                                <span class="post-nav">Next article
                                 <i class="fa fa-angle-right"></i>
                                </span>
            ...
            <div id="comments" class="comments-area">
                <div id="respond" class="comment-respond">
                    ...
                    <form id="comment_form" method="post">
                        <c:if test="${sessionScope.user!=null}">
                            <div class="user_avatar">
                                <img alt="言曌"
                                     ...
                                     class="avatar avatar-64 photo" height="64" width="64">
                                Loginer：${sessionScope.user.userNickname}
                        ...
                        <div class="clear"></div>
                        <p class="form-submit">
                            <input id="submit" name="submit" type="submit" tabindex="5" value="Submit comments">
