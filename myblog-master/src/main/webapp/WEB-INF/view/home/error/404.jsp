...
<div class="error-page">
    <div class="error-page-container">
        <div class="error-page-main">
            <h3>
                <strong>404</strong>Sorry, the page you requested does not exist！
            </h3>
            <div class="error-page-actions">
                <div>
                    <h4>Possible reasons：</h4>
                    <ol>
                        <li>Network signal difference is unstable</li>
                        <li>The requested page could not be found</li>
                ...
                <div>
                    ...
                    <ol>
                        ...
                        <li><a href="https://shulei.com/message.html">Comment about the problem</a></li>
                        <li>
                            <a target="_blank" rel="external nofollow" href="http://wpa.qq.com/msgrd?v=3&amp;uin=1073235415&amp;site=qq&amp;menu=yes"><i class="fa fa-qq"></i>Connect the writer</a>
                        </li>
                    </ol>
                </div>
            </div>
