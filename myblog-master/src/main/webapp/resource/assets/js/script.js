...
(function ($) {
    ...
    function write() {
        var content = "<div class=\"ds-dialog\" id='PAY_" + id + "'>"
            ...
            + "    <h5>Choose tip method：</h5>"
            + "    <div class=\"ds-payment-way\">"
            + "     <label for=\"wechat\"><input type=\"radio\" id=\"wechat\" class=\"reward-radio\" value=\"0\" checked=\"checked\" name=\"reward-way\" />Wechatpay</label>"
            + "     <label for=\"qqqb\"><input type=\"radio\" id=\"qqqb\" class=\"reward-radio\" value=\"1\" name=\"reward-way\" />QQ Pay</label>"
