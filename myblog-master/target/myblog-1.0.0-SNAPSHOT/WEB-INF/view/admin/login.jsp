...
<div id="login">
    <h1><a href="/" title="Welcome to myblog！" tabindex="-1">${options.optionSiteTitle}</a></h1>
    <%
         String username = "";
         String password = "";
         //获取当前站点的所有Cookie
    ...
    <form name="loginForm" id="loginForm"  method="post">
        ...
        <p class="forgetmenot"><label for="rememberme"><input name="rememberme" type="checkbox" id="rememberme" value="1" checked /> Remember the password</label></p>
        <p class="submit">
            <input type="button" name="wp-submit" id="submit-btn" class="button button-primary button-large" value="Login" />
        </p>
    </form>
    ...
    <p id="backtoblog"><a href="/">&larr; Back to myblog</a></p>
